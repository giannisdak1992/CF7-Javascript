...
//Copy deep Copy
const citiesCopy1 = JSON.parse(JSON.stringify(cities)) //JSON stringify convert a JSON to strings

const cities2 = structuredClone() //gets a JS object and creates a deep copy
